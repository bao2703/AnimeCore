...
namespace Entities.DataInitializer
{
    public static class Seeder
    {
        public static void Seed(this IApplicationBuilder app)
        {
            ...
            var genresDic = new Dictionary<string, Genre>
            {
                {
                    action, new Genre
                    {
            ...
            var genres = genresDic.ToDictionary(gerne => gerne.Key, gerne => new GenreMovie {Genre = gerne.Value});
            ...
            context.Genres.AddRange(genresDic.Values);
